...
let "sample=${1}+1"
cp /uscms_data/d3/dmendis/80xB2Gana7/CMSSW_8_0_20/src/Analysis/VLQAna/test/Condor/tZtZ1000MU1skim/SingleMu3/SingleMu3_${sample}.py .
...
xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/SingleMu3
#xrdcp *.root root://cmseos.fnal.gov//store/user/dmendis/ntuples2016/reminiaod/batch2/Muons/SingleMu3
rm SingleMu3_${sample}.py
rm *.root
ls
echo "DONE!"
