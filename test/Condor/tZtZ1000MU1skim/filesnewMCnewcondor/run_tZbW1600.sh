...
xrdcp root://cmseos.fnal.gov//store/user/dmendis/toCondor/muon/tZbW1600/tZbW1600_${sample}.py .
echo "cmsRun"
cmsRun tZbW1600_${sample}.py

rm Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt
echo "xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tZbW1600"

xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tZbW1600
rm tZbW1600_${sample}.py
rm *.root
rm *.py
cd ../../../../../../..
rm -rf CMSSW_8_0_20
