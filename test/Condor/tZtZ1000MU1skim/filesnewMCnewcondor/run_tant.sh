...
xrdcp root://cmseos.fnal.gov//store/user/dmendis/toCondor/muon/tant/tant_${sample}.py .
echo "cmsRun"
cmsRun tant_${sample}.py

rm Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt
echo "xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tant"

xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tant
rm tant_${sample}.py
rm *.root
rm *.py
cd ../../../../../../..
