...
xrdcp root://cmseos.fnal.gov//store/user/dmendis/toCondor/muon/tt/tt_${sample}.py .
echo "cmsRun"
cmsRun tt_${sample}.py

rm Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt
echo "xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tt"

xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tt
rm tt_${sample}.py
rm *.root
rm *.py
cd ../../../../../../..
