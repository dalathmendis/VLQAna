...
xrdcp root://cmseos.fnal.gov//store/user/dmendis/toCondor/muon/bWbW1700/bWbW1700_${sample}.py .
echo "cmsRun"
cmsRun bWbW1700_${sample}.py

rm Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt
echo "xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/bWbW1700"

xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/bWbW1700
rm bWbW1700_${sample}.py
rm *.root
rm *.py
cd ../../../../../../..
rm -rf CMSSW_8_0_20
