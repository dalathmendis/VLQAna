...
xrdcp root://cmseos.fnal.gov//store/user/dmendis/toCondor/muon/tZtH1700/tZtH1700_${sample}.py .
echo "cmsRun"
cmsRun tZtH1700_${sample}.py

rm Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt
echo "xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tZtH1700"

xrdcp *.root root://cmseos.fnal.gov//store/group/lpcbprime/noreplica/dmendis/0530elnew/Muons2/tZtH1700
rm tZtH1700_${sample}.py
rm *.root
rm *.py
cd ../../../../../../..
rm -rf CMSSW_8_0_20
